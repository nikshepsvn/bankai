...
The layer-set explanation Experiment 6 offered for its trig gap has since been tested end to end: the hypothesis is falsified in [Experiment 12](#experiment-12-corrected-metric-replication) and the premise it rested on is contradicted in [Experiment 15](#experiment-15-calculus-layer-impact-map), which supplies the layer map that was cited but never committed.
